...
export function Projects({ isLoading = false, onReload }: ProjectsProps) {
  return (
    <section id="projects" className="min-h-screen py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        >
          ...
          {/* Sync status and optional re-sync control */}
          <div className="flex items-center gap-3">
            {isLoading ? (
              <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-mono">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[11px] font-mono">
                  ...
                  <span>8 BUILDS LOADED</span>
                </div>
                {onReload && (
                  <button
                    onClick={onReload}
                    aria-label="Re-initialize project data"
                    className="p-1.5 rounded-full bg-[#161618] hover:bg-[#202024] border border-[#f5f5f0]/10 hover:border-amber-400/40 text-[#f5f5f0]/40 hover:text-amber-400 transition-all duration-200 cursor-pointer"
                    title="Simulate / Re-fetch project archive"
                  >
                            ...
                            <div className="flex items-center justify-between relative z-10">
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-[#f5f5f0]/40 group-hover:text-[#f5f5f0]/60 transition-colors duration-300 mt-1">
                                    {project.desc}
                                  </p>
                                </div>
                              </div>
